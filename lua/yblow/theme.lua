...
local function set_highlights()
	...
	local default_highlights = {
		...
		Conceal = { bg = "NONE" },
		CurSearch = { fg = palette.pine_canopy, bg = palette.chalk },
		...
		IncSearch = { fg = palette.pine_canopy, bg = palette.ice },
		...
		Search = { fg = palette.parchment, bg = palette.ice, blend = 40 },
		...
		TabLineSel = { fg = palette.parchment, bg = palette.sea_glass, bold = styles.bold },
		...
		["@keyword.include"] = { fg = palette.steel },
		...
		["@tag"] = { link = "Tag" },
		["@tag.attribute"] = { fg = palette.steel },
