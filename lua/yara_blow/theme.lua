...
local function set_highlights()
	...
	local default_highlights = {
		...
		StatusLine = { fg = palette.shadow, bg = palette.text },
		StatusLineNC = { fg = palette.mist, bg = palette.reef },
		StatusLineTerm = { fg = palette.shadow, bg = palette.text },
		...
		MiniStatuslineDevinfo = { fg = palette.mist, bg = palette.reef },
		MiniStatuslineFileinfo = { link = "MiniStatuslineDevinfo" },
		MiniStatuslineFilename = { fg = palette.harbor, bg = palette.reef },
		MiniStatuslineInactive = { link = "MiniStatuslineFilename" },
		MiniStatuslineModeCommand = { fg = palette.shadow, bg = palette.text, bold = styles.bold },
		MiniStatuslineModeInsert = { fg = palette.shadow, bg = palette.text, bold = styles.bold },
		MiniStatuslineModeNormal = { fg = palette.shadow, bg = palette.text, bold = styles.bold },
		MiniStatuslineModeOther = { fg = palette.shadow, bg = palette.text, bold = styles.bold },
		MiniStatuslineModeReplace = { fg = palette.shadow, bg = palette.text, bold = styles.bold },
		MiniStatuslineModeVisual = { fg = palette.shadow, bg = palette.text, bold = styles.bold },
