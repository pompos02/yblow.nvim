...
local function set_highlights()
	...
	local default_highlights = {
		...
		StatusLine = { fg = palette.text, bg = palette.c4 },
		...
		Visual = { bg = palette.c12, blend = 50 },
		...
		xmlAttrib = { fg = palette.text },
		xmlCdata = { link = "String" },
		xmlCdataCdata = { link = "Statement" },
		xmlCdataEnd = { fg = palette.text },
		xmlCdataStart = { fg = palette.text },
		xmlComment = { link = "Comment" },
		xmlDocTypeDecl = { fg = palette.text },
		xmlDocTypeKeyword = { link = "Keyword" },
		xmlEndTag = { fg = palette.text },
		xmlEntity = { link = "Special" },
		xmlEntityPunct = { fg = palette.text },
		xmlEqual = { fg = palette.text },
		xmlError = { link = "Error" },
		xmlProcessing = { fg = palette.text },
		xmlProcessingDelim = { fg = palette.text },
		xmlString = { link = "String" },
		xmlTag = { fg = palette.text },
		xmlTagName = { fg = palette.text },
		xmlTodo = { link = "Todo" },
