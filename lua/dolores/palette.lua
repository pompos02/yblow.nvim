...
local palette = {
	...
	asotos = {
		dark = {
			bg = "#16181a", -- main background
			c1 = "#16181a", -- dim background
			c2 = "#1e2124", -- raised surface
			c3 = "#1e2124", -- active surface
			c4 = "#3c4048", -- accent surface
			c5 = "#7b8496", -- muted foreground
			c6 = "#7b8496", -- secondary foreground
			text = "#ffffff", -- primary foreground
			c7 = "#ffffff", -- strong foreground
			c8 = "#f1ff5e", -- warning accent
			c9 = "#7b8496", -- comment accent
			c10 = "#5eff6c", -- success accent
			c11 = "#ff6e5e", -- error accent
			c12 = "#5ea1ff", -- cool highlight
			c13 = "#5ef1ff", -- type accent
			c14 = "#bd5eff", -- primary accent
			c15 = "#ffbd5e", -- search accent
			c16 = "#ff5ef1", -- tertiary accent
			c17 = "#3c4048", -- selected surface
			c18 = "#3c4048", -- cursor surface
		},
		light = {
			bg = "#ffffff", -- main background
			c1 = "#ffffff", -- dim background
			c2 = "#eaeaea", -- raised surface
			c3 = "#eaeaea", -- active surface
			c4 = "#acacac", -- accent surface
			c5 = "#7b8496", -- muted foreground
			c6 = "#7b8496", -- secondary foreground
			text = "#16181a", -- primary foreground
			c7 = "#16181a", -- strong foreground
			c8 = "#997b00", -- warning accent
			c9 = "#7b8496", -- comment accent
			c10 = "#008b0c", -- success accent
			c11 = "#d11500", -- error accent
			c12 = "#0057d1", -- cool highlight
			c13 = "#008c99", -- type accent
			c14 = "#a018ff", -- primary accent
			c15 = "#d17c00", -- search accent
			c16 = "#d100bf", -- tertiary accent
			c17 = "#eaeaea", -- selected surface
			c18 = "#acacac", -- cursor surface
		},
	},
	kif = {
		dark = {
	...
	glykeria = {
		...
		light = {
			...
			c2 = "#f3efd2", -- raised surface
			c3 = "#f3e2b8", -- active surface
