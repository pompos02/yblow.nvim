...
local palette = {
	dolores = {
		dark = {
			...
			c15 = "#b04ac0", -- Search, IncSearch, CurSearch background
		...
		light = {
			...
			c15 = "#b33cce", -- Search, IncSearch, CurSearch background
	...
	kif = {
		dark = {
			...
			c15 = "#952aa3", -- Search, IncSearch, CurSearch background
	...
	thalasses = {
		dark = {
			...
			c15 = "#d19a66", -- Search, IncSearch, CurSearch background
		...
		light = {
			...
			c15 = "#d18f52", -- Search, IncSearch, CurSearch background
	...
	stratos = {
		dark = {
			...
			c15 = "#fd971f", -- Search, IncSearch, CurSearch background
	...
	["sotiria-bellou"] = {
		dark = {
			...
			c15 = "#e78a4e", -- Search, IncSearch, CurSearch background
		...
		light = {
			...
			c15 = "#c35e0a", -- Search, IncSearch, CurSearch background
	...
	glykeria = {
		dark = {
			...
			c14 = "#d3869b", -- constants, booleans, numbers, labels, titles, directories
			c15 = "#fe8019", -- Search, IncSearch, CurSearch background
		...
		light = {
			...
			c15 = "#d65d0e", -- Search, IncSearch, CurSearch background
